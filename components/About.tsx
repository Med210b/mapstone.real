      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <CardContainer className="inter-var mb-8">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
              <CardItem translateZ="50" className="w-full mb-6">
                <img src="https://res.cloudinary.com/dlyhuwdrw/image/upload/v1778589234/n6j3kgapdmc76javyaix.png" className="h-60 w-full object-cover rounded-xl" />
              </CardItem>
          ...
          <CardContainer className="inter-var">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
              <CardItem translateZ="80" className="w-full mt-4">
                <img src="https://res.cloudinary.com/dlyhuwdrw/image/upload/v1778589234/bzncm1r1kegw0or5adix.png" className="h-60 w-full object-cover rounded-xl grayscale group-hover/card:grayscale-0" />
              </CardItem>
        ...
        <StickySection title="The Standard" number="03">
          <CardContainer className="inter-var">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
              <CardItem translateZ="50" className="w-full mb-6">
                <img src="https://res.cloudinary.com/dlyhuwdrw/image/upload/v1778589234/aiqgbjyvh62kzabnip5n.png" className="h-60 w-full object-cover rounded-xl" />
              </CardItem>
        ...
        <StickySection title="Connectivity" number="04">
          <CardContainer className="inter-var">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
              <CardItem translateZ="100" className="w-full"><img src="https://res.cloudinary.com/dlyhuwdrw/image/upload/v1778589289/eeora2omllffjo3h2tw8.png" /></CardItem>
