...
// ERROR FIX: Removed "import BackgroundEffect..." because it is now global in App.tsx

// --- INTERNAL UTILS & CARD COMPONENTS (Keep as is) ---
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <CardContainer className="inter-var mb-8">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50 transition-colors duration-500">
              <CardItem translateZ="50" className="w-full mb-6">
                <img src="https://kadibusiness.com/wp-content/uploads/2024/02/Dubai-Economy-and-Tourism.jpg" alt="Vision" className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl" />
              </CardItem>
              <CardItem translateZ="60" className="text-xl font-bold text-white mb-2">{t.about.vision_title}</CardItem>
              <CardItem as="p" translateZ="40" className="text-gray-300 text-sm max-w-sm">{t.about.vision_desc}</CardItem>
            </CardBody>
          </CardContainer>
        </StickySection>
          ...
          <CardContainer className="inter-var">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
              <CardItem translateZ="80" className="w-full mt-4">
                <img src="https://i.postimg.cc/76ctw2Kg/66.jpg" alt="Interior" className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl grayscale group-hover/card:grayscale-0 transition-all duration-500" />
              </CardItem>
              <div className="flex flex-col md:flex-row gap-6 mt-8">
                <div>
                  <CardItem translateZ="50" className="text-xl font-header text-[#D4AF37] mb-2">{t.about.precision}</CardItem>
                  <CardItem translateZ="40" className="text-gray-400 text-sm">{t.about.precision_desc}</CardItem>
                </div>
                <div>
                  <CardItem translateZ="50" className="text-xl font-header text-[#D4AF37] mb-2">{t.about.discretion}</CardItem>
                  <CardItem translateZ="40" className="text-gray-400 text-sm">{t.about.discretion_desc}</CardItem>
                </div>
              </div>
            </CardBody>
          </CardContainer>
        ...
        <StickySection title={t.about.standard} number="03">
          <CardContainer className="inter-var">
            <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50 transition-colors duration-500">
              <CardItem translateZ="50" className="w-full mb-6">
                 <img src="https://i.postimg.cc/nVW3NT4R/Whats-App-Image-2025-09-04-at-01-18-25-e24c3ba8.jpg" alt="Standard" className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl" />
              </CardItem>
              <CardItem translateZ="60" className="font-header text-2xl md:text-3xl text-white leading-tight text-center mt-4 px-4">"{t.about.quote}"</CardItem>
            </CardBody>
          </CardContainer>
        </StickySection>
          ...
          <CardContainer className="inter-var">
             <CardBody className="bg-black/40 relative group/card border-white/10 w-full h-auto rounded-xl p-6 border hover:border-[#D4AF37]/50">
                <CardItem translateZ="100" className="w-full">
                  <img src="https://www.caterermiddleeast.com/cloud/2022/02/26/dubai-tourism-news-2021.jpg" alt="Global Reach" className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl opacity-80" />
                </CardItem>
                <CardItem translateZ="50" className="text-2xl font-header text-white mt-8 mb-2">{t.about.global_reach}</CardItem>
                <CardItem translateZ="30" className="text-gray-400">{t.about.reach_desc}</CardItem>
             </CardBody>
          </CardContainer>
        </StickySection>
