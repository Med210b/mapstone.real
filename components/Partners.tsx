...
// FIX: Using 'any' to bypass strict TS checks
...
const pillars = [
  { title: "Global Reach", desc: "Connecting Dubai's finest developments to investors in London, New York, and Singapore.", icon: <Globe className="w-10 h-10 text-[#D4AF37]" /> },
  { title: "Elite Standards", desc: "We only partner with developers who meet our rigorous criteria for quality and delivery.", icon: <Award className="w-10 h-10 text-[#D4AF37]" /> },
  { title: "Secure Investment", desc: "Ensuring every project offers not just luxury, but long-term capital appreciation.", icon: <ShieldCheck className="w-10 h-10 text-[#D4AF37]" /> }
];
