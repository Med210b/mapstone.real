      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <img src="https://res.cloudinary.com/dlyhuwdrw/image/upload/v1778587551/yds2h1bzdd61tt4jwxs2.png" alt="Mapstone Real Estate" className="h-24 w-auto object-contain" />
