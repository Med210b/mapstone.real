export const translations = {
  ...
  // ... (Copy the structure above to FR, AR, ES, etc. and translate the values)
  FR: { /* Paste EN structure here and translate values to French */ },
  AR: { /* Paste EN structure here and translate values to Arabic */ },
  // etc...
};